...
<div class="log">
	<div class="content1">
		<h2>学 生 登 录</h2>
		<form method="POST" name="frmlogin" action="loginCh.jsp">
			...
			<div class="button-row">
				...
				<input type="button" class="reset" value="返 回" onclick="javascript:window.location.href ='http://localhost:8080/Gly/index.jsp'">
				<div class="clear"></div>
			</div>
		</form>
	</div>
